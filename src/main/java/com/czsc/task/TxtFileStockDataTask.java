...
import com.czsc.util.TxtFileUtil;
...
@Slf4j
@Component
public class TxtFileStockDataTask {
    ...
    public void dealData() throws ParseException {
        ...
        List<StockTable> stockTables = buildStockTable("000001_pre", total, dateStr, priceStr, priceFactor, volumnStr, yearCountMap);
        if (CollectionUtils.isEmpty(stockTables)) {
            log.error("get history data empty. symbol : {}", "000001_pre");
        }
